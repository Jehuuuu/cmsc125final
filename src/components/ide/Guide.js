export default function Guide() {
    return (
        <div className="guide">
            <header className="guide-header">Guide</header>

            <div className="guide-content">
                <p className="note">
                    Note: Always say <strong>"please."</strong> at the end of the voiced instruction because it serves as the <strong>ENTER</strong> key.
                </p>
